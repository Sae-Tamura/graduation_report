...
オープンボキャブラリシーングラフ生成（OvSGG）は，未知の物体や関係語を副務画像に対しても柔軟に対応することを目的としたタスクである．本節では，代表的な研究として，OvSGTR\cite{ovsgtr}とPGSG\cite{pgsg}を取り上げる．
...
OvSGTRにおけるVLMの活用は，CLIP\cite{clip}やGrounding DINO\cite{groundingdino}などの判別型モデルを利用して視覚と言語の埋め込み空間を整合させる特徴整合型アプローチであり，VLMはあくまで意味空間の橋渡し役として機能している．なお，LLMによる生成的推論は導入されておらず，今後の課題として言及されている．
